    ...
    <div className="min-h-screen bg-background dark">
      ...
      <section className="container mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="group relative rounded-xl border border-border bg-muted/50 p-8 transition-colors hover:bg-muted animate-fade-in">
            <div className="mb-4">
          ...
          <div className="group relative rounded-xl border border-border bg-muted/50 p-8 transition-colors hover:bg-muted animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <div className="mb-4">
              <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-foreground text-background">
          ...
          <div className="group relative rounded-xl border border-border bg-muted/50 p-8 transition-colors hover:bg-muted animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="mb-4">
              <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-foreground text-background">
